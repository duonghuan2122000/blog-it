...
<form action="" method="POST" role="form" enctype="multipart/form-data">
	...
	">
		...
		<input type="text" class="form-control" name="name" id="name" placeholder="Nhập tên của truyện" value="<?php echo $story->name; ?>">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="author" id="author" placeholder="Nhập tên của tác giả" value="<?php echo $story->author; ?>">
	</div>
	...
	<div class="form-group">
		...
		<img src="<?php echo base_url('assets/img/'.$story->img) ?>" alt="<?php echo $story->name; ?>">
	</div>			
	
	<div class="form-group">
		<label for="description">Tóm tắt</label>
		<textarea id="description" name="description"><?php echo $story->description; ?></textarea>
	</div>
