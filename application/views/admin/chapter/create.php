	...
	<form action="" method="POST" role="form">
		...
		">
			...
			<input type="number" class="form-control" name="num" id="chapter" placeholder="Nhập số chương của truyện" value="<?php echo set_value('num') ?>">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="name_chapter" name="name" placeholder="Nhập tên của chương truyện nếu có" value="<?php echo set_value('name') ?>">
		</div>			
